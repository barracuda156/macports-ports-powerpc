...
proc wxWidgets._set {option action args} {
    ...
    } elseif {${args} eq "wxX11-3.2"} {
        wxWidgets.name      "wxX11"
        wxWidgets.version   "3.2"
        wxWidgets.port      "wxx11-3.2"
    } else {
        # throw an error
        ui_error "invalid parameter for wxWidgets.use; use one of:\n\twxWidgets-2.8/wxGTK-2.8/wxWidgets-3.0/wxGTK-3.0/wxPython-3.0/wxWidgets-3.2/wxGTK-3.2"
